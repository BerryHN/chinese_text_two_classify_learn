...
tf.flags.DEFINE_string("positive_data_file", os.path.join(base_path,'data/ham_100.utf8'), "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", os.path.join(base_path,'data/spam_100.utf8'), "Data source for the negative data.")
...
x = np.array(word2vec_helpers.embedding_sentences(sentences, embedding_size = FLAGS.embedding_dim, file_to_save = os.path.join(base_path, 'model/trained_word2vec.model')))
